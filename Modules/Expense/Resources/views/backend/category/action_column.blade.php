<div class="text-end d-flex gap-2 align-items-center">
    ...
    @hasPermission('delete_tax')
        <a href="{{ route('backend.expenses-categories.destroy', $data->id) }}" id="delete-{{ $module_name }}-{{ $data->id }}"
            ...
            data-confirm="{{ __('messages.are_you_sure?', ['module' => __('expense.expense_category'), 'name' => $data->title]) }}">
