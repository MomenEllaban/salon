...
@section('content')
    <div class="card">
            ...
            <x-backend.section-header>
                ...
                <x-slot name="toolbar">
                    ...
                    @hasPermission('add_tax')
                        <button type="button" class="btn btn-primary" data-crud-id="{{ 0 }}" title=""><i
        ...
        <div data-render="app">
            <expense-category-form-offcanvas create-title="{{ __('messages.new') }} {{ __($module_title) }}"
    ...
    <script type="text/javascript">
        const finalColumns = [{
            ...
            },
            {
                data: 'name',
                name: 'name',
                title: "{{ __('expense.lbl_name') }}",
                width: '35%',
            },
            {
                data: 'category_code',
                name: 'category_code',
                title: "{{ __('expense.lbl_category_code') }}",
                width: '35%'
            },
            {
                data: 'status',
                name: 'status',
                title: "{{ __('expense.lbl_status') }}",
                width: '5%',
            },
            {
                data: 'action',
                name: 'action',
                title: "{{ __('expense.lbl_action') }}",
                orderable: false,
                searchable: false,
                width: '5%',
            },
