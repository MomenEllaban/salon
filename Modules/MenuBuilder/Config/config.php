...
return [
    ...
    'ARRAY_MENU' => [
        ...
        [
            'start_icon' => 'fa-solid fa-money-bill-wheat',
            'title' => 'sidebar.expense',
            'menu_item_type' => 'parent',
            'permission' => ['view_tax'],
            'order' => 14,
            'children' => [
                ...
                [
                    'title' => 'sidebar.categories',
                    'route' => 'backend.expenses-categories.index',
                    'active' => ['app/expense-category'],
                    'permission' => ['view_tax'],
                    'order' => 1,
                    'menu_level' => 1,
                ],
                [
                    'title' => 'sidebar.sub_categories',
                    'route' => 'backend.expenses-categories.index_nested',
                    'active' => ['app/sub-categories'],
                    'permission' => ['view_tax'],
                    'order' => 2,
                    'menu_level' => 1,
